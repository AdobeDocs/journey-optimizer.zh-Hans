...
➡️ [了解有关集成概述的更多信息](external-sources.md)
...
➡️ [了解有关管理员和营销人员工作流的更多信息](external-sources.md)
...
➡️ [了解有关创建集成的更多信息](external-sources.md#configure)
...
➡️ [了解有关第三方系统示例数据的更多信息](external-sources.md)
...
➡️ [了解有关集成配置的更多信息](external-sources.md#configure)
...
➡️ [了解有关身份验证类型的更多信息](external-sources.md#configure)
...
➡️ [了解有关响应有效负载映射的更多信息](external-sources.md#configure)
...
➡️ [了解有关集成个性化的更多信息](external-sources.md#personalization)
...
➡️ [了解有关历程和营销活动的更多信息](external-sources.md#limitations)
...
➡️ [了解有关片段和Beta版限制的更多信息](external-sources.md#limitations)
...
➡️ [了解有关受支持渠道的更多信息](external-sources.md#limitations)
...
➡️ [了解有关JSON和响应格式的更多信息](external-sources.md#limitations)
...
➡️ [了解有关检索与列出API的更多信息](external-sources.md#limitations)
...
➡️ [了解有关集成配置位置的更多信息](external-sources.md#configure)

+++

+++ 集成是否会取代Experience Platform源的Adobe Journey Optimizer连接器？

否。 **集成**&#x200B;用于您从API驱动的消息内容中的个性化字段。 **源**&#x200B;和其他数据摄取功能有不同的用途（例如，批量数据摄取和配置文件扩充）。 将每种功能用于其目标范围。

➡️ [了解更多有关集成的用途](external-sources.md)
...
➡️ [了解有关测试连接和负载验证的更多信息](external-sources.md#configure)
...
➡️ [了解有关测试连接和激活的更多信息](external-sources.md#configure)
