...
**在此页面上：**&#x200B;了解如何将Adobe Journey Optimizer连接到其他Adobe解决方案和第三方系统（如Customer Journey Analytics、Experience Manager、Stock、GenStudio、Campaign和Workfront），以扩展其功能范围并帮助您解决特定用例。
...
[![了解详情](../assets/do-not-localize/learn-more-button.svg)](aem-fragments.md)
...
了解有关[Journey Optimizer + Adobe Intelligent Services](intelligent-services.md)的更多信息。
