...
>[!IMPORTANT]
>
>此配置是Adobe Journey Optimizer团队测试的说明性模式。 Adobe Target Recommendations是一个单独的Adobe产品，具有自身的发行周期和API版本控制。 在生产环境中部署之前，请始终通过[Adobe Target开发人员文档](https://experienceleague.adobe.com/zh-hans/docs/target-dev/developer/overview)确认当前API详细信息。
...
➡️激活集成后，了解如何[在内容创作中添加集成](integrations-personalization.md#apply-integration-personalization)以及[在消息模板中使用Adobe Target数据](integrations-personalization.md#use-adobe-target-in-templates)。
