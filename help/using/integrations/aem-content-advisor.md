...
**在此页面上：**&#x200B;了解如何直接在Adobe Experience Manager创作工作流中通过AI支持的语义搜索访问和使用Journey Optimizer内容审查器发现资源、动态媒体和内容片段。
...
1. 在Personalization编辑器中，选择您的内容入口点：
   ...
   * 要添加资源，请单击&#x200B;**[!UICONTROL Assets]**，然后单击&#x200B;**[!UICONTROL 打开AEM内容顾问]**。

     ![](assets/content-advisor-11.png){zoomable="yes"}

   * 要添加Adobe Experience Manager内容片段，请单击&#x200B;**[!UICONTROL AEM内容片段]**，然后单击&#x200B;**[!UICONTROL 打开AEM内容顾问]**。
