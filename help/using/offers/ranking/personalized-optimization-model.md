...
>[!TIP]
>
>决策是 [!DNL Adobe Journey Optimizer] 的全新决策功能，现已通过基于代码的体验和电子邮件渠道提供！ [了解有关Decisioning的更多信息](../../experience-decisioning/gs-experience-decisioning.md)
...
![个性化优化模型动画](../../rn/assets/do-not-localize/ai-ranking.gif)
...
例如，如果银行提供两种信用卡选件，唯一的区别是颜色，那么推荐哪种信用卡可能无关紧要，但如果每张信用卡的条款不同，这便为某些客户为什么选择信用卡提供了理论基础，并为不同选件之间的差异提供了足够的依据，从而构建更具影响力的模型。
