...
>[!NOTE]
>
>如果您是 [Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/landing/home.html?lang=zh-Hans){target="_blank"} 利用 **offer decisioning** 应用程序服务中，本节中介绍的所有决策管理功能也适用于您。
