...
**字段：**&#x200B;特性
**标题：**&#x200B;决策选项特性
**描述：**&#x200B;特性是属于特定决策选项的优惠的附加特性或特性。这些属性是键值对，这意味着它们包含具有关联值的属性名称（有时称为键），并用于区分一个决策选项和其他选件。例如，对于属性名称“color”，特定选件的值可能为“green”。<!--Characteristics are used as values in content that represents this decision option and as features to analyze and optimize the performance of an offer. When every instance has the same attribute or property, that aspect should be modeled as an extension schema that derives from the decision option detail.-->
**类型：**&#x200B;对象
...
**字段：**&#x200B;组件
**描述：**&#x200B;表示决策选项的内容组件，包括其所有语言变体。特定组件由“dx:format”、“dc:subject”和“dc:language”或它们的组合找到。此元数据用于定位或表示与选件关联的内容，并根据版面合同对其进行集成。
**类型：**&#x200B;数组
**必需：** &quot;_type&quot;， &quot;_dc&quot; <!--TBC?-->
...
+++_experience >决策> profileConstraints >配置文件约束类型
