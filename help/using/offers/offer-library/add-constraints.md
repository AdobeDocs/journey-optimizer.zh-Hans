...
<!--
>additional-url="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer/using/decisioning/offer-decisioning/managing-offers-in-the-offer-library/configure-offers/add-constraints#capping-change-date" text="Changing dates can impact capping"-->
...
>[!NOTE]
>
>当计数器从Edge传播到Hub或从Hub传播到Edge区域时，最多可能延迟30分钟。
