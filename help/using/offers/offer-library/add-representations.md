...
使用个性化编辑器，使用合并架构检索存储在Adobe Experience Platform中的配置文件属性。 [了解详情](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schemas-overview.html){target="_blank"}有关决策管理中支持的函数，请参阅表达式编辑器中的[支持的函数](../personalization-editor-supported-functions.md)。
