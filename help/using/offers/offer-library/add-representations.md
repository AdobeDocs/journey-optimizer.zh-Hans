...
>
>在决策管理中使用个性化编辑器时，仅支持函数的子集 — 请参阅个性化编辑器中的[支持的函数](personalization-editor-supported-functions.md)。
...
如果所选版面为HTML类型，则还可以添加来自[Adobe Experience Cloud资源库](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/introduction.html){target="_blank"}的HTML或JSON内容。
...
您可以使用个性化编辑器个性化URL。 了解有关[个性化](../../personalization/personalize.md#use-expression-editor)的更多信息。 在决策管理中，仅支持某些函数 — 请参阅个性化编辑器中的[支持的函数](personalization-editor-supported-functions.md)。
...
1. 键入将在选件中显示的文本。
   ...
   您可以使用个性化编辑器将内容个性化。 了解有关[个性化](../../personalization/personalize.md#use-expression-editor)的更多信息。 在决策管理中，仅支持某些函数 — 请参阅个性化编辑器中的[支持的函数](personalization-editor-supported-functions.md)。
