...
选项2中的以下JavaScript代码片段：HTML页面的[部分中的](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/installing-the-sdk.html)此页面`<head>`上的预建独立版本。
