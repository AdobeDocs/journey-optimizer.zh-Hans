...
| `xdm:profiles.xdm:identityMap` | 此对象基于身份的命名空间集成代码包含一组最终用户身份。 标识映射可以携带每个命名空间的多个标识。 有关命名空间的更多信息，请参阅 [本页](../../../segment/get-started-identity.md). | `Email: [{"xdm:id": "123@abc.com"}]` |
