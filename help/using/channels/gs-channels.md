...
了解如何通过Meta的Cloud API集成和使用WhatsApp消息传送功能，以提供个性化和合规的通信活动和历程。

[了解有关WhatsApp消息传送的更多信息](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
了解如何配置、创建和个性化LINE消息，以便在营销活动和历程中进行有效通信。

[了解有关LINE消息传送的更多信息](../../rp_landing_pages/line-landing-page.md)
:::
