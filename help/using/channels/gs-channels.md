...
**在此页面上：** Adobe Journey Optimizer 的原生渠道让您能够通过出站投放和入站体验触达客户——比较电子邮件、短信、推送、实时活动、直邮、WhatsApp、LINE、应用程序内、Web、基于代码和内容卡片，了解每个渠道在历程和营销活动中的支持情况。
...
直接在 iPhone 锁屏界面与灵动岛上呈现持续的实时更新。 通过 API 触发的针对个体用例（订单跟踪、行程状态）或广播用例（体育得分、航班状态）的营销活动来推动实时活动。

[了解有关 iOS 实时活动的更多信息](../mobile-live/get-started-mobile-live.md)
:::
...
[了解有关移动消息的更多信息](../mobile/get-started-mobile.md)
:::
...
了解如何通过 Meta 的 Cloud API 集成和使用 WhatsApp 消息，以实现个性化且合规的通信营销活动。

[了解有关 WhatsApp 消息的更多信息](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
了解如何配置、创建和个性化 LINE 消息，以便在营销活动和历程中进行高效通信。

[了解有关 LINE 消息的更多信息](../../rp_landing_pages/line-landing-page.md)
:::
...
下表显示了每种渠道在不同历程和营销活动下的可用性，并说明了其受支持的范围。

| 渠道 | 历程 | 操作营销活动（营销型） | 操作营销活动（事务型） | API 触发的营销活动 | 编排的营销活动 |
|----------------------|----------|------------------------------|----------------------------------|-------------------------|------------------------|
| 电子邮件 | ✅ | ✅ | ✅ | ✅ | ✅ |
| 短信 | ✅ | ✅ | ✅ | ✅ | ✅ |
| 推送通知 | ✅ | ✅ | ✅ | ✅ | ✅ |
