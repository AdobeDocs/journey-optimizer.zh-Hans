...
Journey Optimizer允许您在发布协调的活动之前对其进行测试。 这允许您检查构成营销活动的各种任务的执行情况和结果，并且没有功能影响：画布中的所有活动都会执行，但具有影响&#x200B;**[!UICONTROL 保存受众]**&#x200B;和渠道活动的活动除外。

要在测试模式下启动编排的营销活动，请打开编排的营销活动，然后单击&#x200B;**[!UICONTROL 启动]**&#x200B;按钮。

![](assets/campaign-start.png){zoomable="yes"}

运行编排的活动后，画布中的每个活动都会按顺序执行，直到达到编排的活动结束为止。

当您的营销活动准备好上线时，单击&#x200B;**[!UICONTROL 发布]**&#x200B;按钮。 画布中的可视流将重新启动，从而允许您查看用户档案在图中的进度。

## 编排的营销活动可视流程

在测试模式下或生产模式下运行编排的活动时，您可以使用可视流量实时跟踪不同任务中目标用户档案的进度。 这允许您快速识别每个活动的状态以及它们之间转换的用户档案数。

![](assets/workflow-execution.png){zoomable="yes"}

通过过渡从一个活动传输到另一个活动的数据存储在临时工作表中。 可以为每个过渡显示此数据。 要实现此目的，请选择过渡以在屏幕右侧打开其属性。
