...
此时会显示可添加到“已编排”营销活动画布的活动列表。 可用的活动取决于您在编排的活动画布中的位置。 例如，添加第一个活动时，您可以通过定义受众（例如，具有&#x200B;**构建受众**、**读取受众**&#x200B;或&#x200B;**加载文件**）、拆分编排的营销活动路径或设置&#x200B;**等待**&#x200B;活动以延迟编排的营销活动执行，来启动编排的营销活动。 另一方面，在&#x200B;**构建受众**&#x200B;活动后，您可以通过定位活动优化目标，通过渠道活动向受众发送投放，或通过流量控制活动组织编排的营销活动流程。
