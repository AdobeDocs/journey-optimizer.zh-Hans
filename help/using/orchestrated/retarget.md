...
基于反馈的重定位规则允许您根据&#x200B;**[!UICONTROL 消息反馈]**&#x200B;架构中捕获的消息投放事件重新定位收件人。 这些事件包括发送、打开、退回或标记为垃圾邮件的邮件。

利用此数据，您可以定义规则来识别收到上一封邮件的收件人，从而启用基于特定投放状态的跟进通信。

1. 创建新的&#x200B;**[!UICONTROL 编排的营销活动]**。

1. 添加&#x200B;**[!UICONTROL 生成受众]**&#x200B;活动并将定向维度设置为&#x200B;**[!UICONTROL 收件人(caas)]**。 单击&#x200B;**[!UICONTROL 继续]**。

1. 若要快速入门，您可以使用内置&#x200B;**[!UICONTROL 营销活动反馈]**&#x200B;筛选器根据邮件投放事件定位收件人。

   +++ 详细的分步说明

   1. 在&#x200B;**[!UICONTROL 规则生成器]**&#x200B;中，单击&#x200B;**[!UICONTROL 选择或保存筛选器]**，然后从列表中选择&#x200B;**[!UICONTROL 促销活动反馈]**。

   1. 选择筛选器规则并选择要定位的&#x200B;**[!UICONTROL 行为]**，如&#x200B;**[!UICONTROL 发送的邮件]**。

   1. 单击![文件夹图标](assets/do-not-localize/folder-search.svg)以选择要重新定位的特定营销活动。 您有两个选项：

      * **[!UICONTROL 选择特定营销活动]**：从列表中选择特定营销活动，以重新定位与该营销活动进行交互的收件人。

      * **[!UICONTROL 来自过渡的营销活动]**：引用编排营销活动中上一个活动的营销活动。

   +++

1. 或者，您也可以手动构建自定义规则。 在&#x200B;**[!UICONTROL 规则生成器]**&#x200B;中，单击&#x200B;**[!UICONTROL 添加条件]**，然后从&#x200B;**[!UICONTROL 属性选取器]**&#x200B;中选择&#x200B;**[!UICONTROL 消息反馈]**。 单击&#x200B;**[!UICONTROL 确认]**&#x200B;创建&#x200B;**存在消息反馈，如**&#x200B;条件。
...
基于跟踪的重定位规则使用&#x200B;**[!UICONTROL 电子邮件跟踪]**&#x200B;架构中的数据，根据收件人与消息的交互来定位收件人。 它捕获用户操作，如电子邮件打开和链接点击。
...
1. 若要快速入门，您可以使用内置&#x200B;**[!UICONTROL 营销活动反馈]**&#x200B;筛选器根据邮件投放事件定位收件人。
   ...
   1. 选择筛选器规则并选择要定位的&#x200B;**[!UICONTROL 行为]**，如&#x200B;**[!UICONTROL 打开的消息]**&#x200B;或单击了&#x200B;**[!UICONTROL 消息]**。
...
1. 或者，您也可以手动构建自定义规则。 在&#x200B;**[!UICONTROL 规则生成器]**&#x200B;中，单击&#x200B;**[!UICONTROL 添加条件]**，然后从&#x200B;**[!UICONTROL 属性选取器]**&#x200B;中选择&#x200B;**[!UICONTROL 电子邮件跟踪]**。
