...
**在此页面上：**&#x200B;了解如何在Adobe Journey Optimizer中创建编排的活动并定义其执行计划，以便在特定日期和时间立即运行或定期运行。
...
>title="精心编排的营销活动列表"
>abstract="**编排**&#x200B;选项卡中列出了所有精心编排的营销活动。 点击某个精心编排的营销活动的名称可进行编辑。 使用&#x200B;**创建精心编排的营销活动**&#x200B;按钮，添加新编排的营销活动。"
...
>title="调度程序有效期"
>abstract="对于计划营销活动，请为计划程序定义有效期。 它可以是永久有效（默认），也可以在指定日期之前有效。"
