...
>title="结束活动"
>abstract="**End**&#x200B;活动标记画布上分支的结尾。 或者，使用&#x200B;**外部信号**&#x200B;启动下游协调的营销活动，并在分支完成时传递参数。 [了解详情](../trigger-orchestrated-campaign.md#signal-end)"

>[!CONTEXTUALHELP]
>id="ajo_orchestration_signal"
>title="外部信号"
>abstract="选择在此分支结束时启动的下游编排促销活动，并映射要在信号中发送的参数名称和值。 下游营销活动必须设置为&#x200B;**由信号**&#x200B;触发并在此营销活动到达结束活动之前发布。 [了解详情](../trigger-orchestrated-campaign.md#signal-end)"
