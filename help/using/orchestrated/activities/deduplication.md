...
>title="用于识别重复项的字段"
>abstract="在&#x200B;**用于识别重复项的字段**&#x200B;部分，单击&#x200B;**添加属性**&#x200B;按钮，指定可用于识别重复项的字段（例如：电子邮件地址、名字、姓氏等）。字段顺序可用于指定优先处理的字段。"
...
1. 在&#x200B;**[!UICONTROL 用于识别重复项的字段]**&#x200B;部分，单击&#x200B;**[!UICONTROL 添加属性]**&#x200B;按钮，指定可用于识别重复项的字段（例如：电子邮件地址、名字、姓氏等）。字段顺序可用于指定优先处理的字段。
