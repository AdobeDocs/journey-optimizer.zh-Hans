...
* **[设置数据概述教程](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/set-up-data-overview){target="_blank"}** — 对Journey Optimizer中的数据设置进行的一次入门级友好的视频演练，内容涵盖架构、数据集和源端到端。

* **[创建数据集和摄取数据教程](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/create-datasets-and-ingest-data){target="_blank"}** — 一个实践教程，说明如何在Adobe Experience Platform中创建数据集和使用源连接器摄取数据，以及您可以在自己的沙盒中遵循的分步说明。
