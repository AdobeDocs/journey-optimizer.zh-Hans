...
**在此页面上：**&#x200B;使用由 Adobe Experience Platform 查询服务提供支持的查询编辑器，您可以在 Adobe Journey Optimizer 中对客户体验数据编写、验证和运行查询，以进行分析和数据探索。
...
通过[本文档](https://experienceleague.adobe.com/docs/experience-platform/query/ui/user-guide.html?lang=zh-Hans){target="_blank"}了解如何使用查询编辑器。
