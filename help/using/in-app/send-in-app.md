...
如果您希望在所有用户应用内通知上线之前先查看一下该通知，则可以在特定设备上预览该通知。 此功能允许您确保通知在选定设备上的外观和功能与预期一致，从而为受众提供更好的用户体验。
...
现在可以直接在设备上触发应用程序内消息，从而预览和查看实际设备上的消息。

## 查看并激活应用程序内通知{#in-app-review}

创建应用程序内消息，并定义其内容并对其进行个性化后，您可以查看和激活该消息。

为此，请执行以下步骤：

1. 使用 **[!UICONTROL 查看以激活]** 按钮以显示消息的摘要。
...
您的营销活动现已激活。 立即或在指定日期发送在营销活动中配置的应用程序内通知。
