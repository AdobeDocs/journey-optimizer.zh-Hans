...
营销活动全局报告可直接通过 **[!UICONTROL All time]** 按钮。
...
* **[!UICONTROL Excluded]**:Adobe Journey Optimizer已排除的用户档案数。
...
从营销策划 **[!UICONTROL Global report]**, **[!UICONTROL Push notification]** 选项卡详细列出了与营销活动中发送的推送投放相关的主要信息。
...
从营销策划 **[!UICONTROL Global report]**, **[!UICONTROL SMS]** 选项卡详细列出了与营销活动中发送的短信投放相关的主要信息。
