...
历程 **[!UICONTROL 全局报告]** 分为多个构件，其中详细描述历程的成功和错误。 如果需要，可以调整每个小部件的大小并将其删除。 有关此内容的更多信息，请参阅此 [部分](global-report.md#modify-dashboard).

有关Adobe Journey Optimizer中可用的每个量度的详细列表，请参阅 [此页面](global-report.md#list-of-components-global).

## “历程”选项卡 {#journey-global}

从您的历程 **[!UICONTROL 全局报告]**，则 **[!UICONTROL 历程]** 选项卡让您清楚地了解历程的最重要的跟踪数据。
...
此 **[!UICONTROL 按事件显示接收的事件]**， **[!UICONTROL 按来源显示的事件]** 和 **[!UICONTROL 热门事件]** 利用小组件，可查看您的 **[!UICONTROL 事件]** 已成功通过图形和表执行。

**[!UICONTROL 操作性能]**， **[!UICONTROL 操作错误原因]** 和 **[!UICONTROL 热门操作]** 构件代表在执行以下操作时最成功的操作和发生的错误： **[!UICONTROL 操作]** 触发。

此 **[!UICONTROL 热门操作]** 表包含可用于以下项的数据： **[!UICONTROL 操作]**，例如：

* **[!UICONTROL 操作已成功执行]**：总数 **[!UICONTROL 操作]** 已成功为历程执行。

* **[!UICONTROL 操作出错]**：发生的错误总数 **[!UICONTROL 操作]**.

此 **[!UICONTROL 同意政策]** 表和图形显示在自定义操作中从每个策略中排除的用户档案数。
有关自定义操作的详细信息，请参阅 [详细文档](../action/about-custom-action-configuration.md).

请注意，要使这些构件显示在历程报表中，您需要重置仪表板。 要执行此操作，请单击 **[!UICONTROL 修改]** 则 **[!UICONTROL 重置]** 在报告的最上方。
+++

## “电子邮件”选项卡 {#email-global}

从您的历程 **[!UICONTROL 全局报告]**，则 **[!UICONTROL 电子邮件]** 选项卡详细列出了与旅程中发送的电子邮件投放相关的主要信息。
...
* **[!UICONTROL 已定位]**：AdobeJourney Orchestration针对任何操作（如发送电子邮件或短信）定向的用户档案数。
...
* **[!UICONTROL 独特打开率]**：已打开的电子邮件总数，与已投放的电子邮件数相比。
...
此 **[!UICONTROL 优惠的详细统计数据]** 表包含选件中收件人活动的可用数据：

* **[!UICONTROL 投放位置名称]**：用于显示优惠的投放位置名称。 有关版面的详细信息，请参阅此 [页面](../offers/offer-library/creating-placements.md).

* **[!UICONTROL 优惠名称]**：在投放中添加的选件名称。 有关版面的详细信息，请参阅此 [页面](../offers/offer-library/creating-personalized-offers.md).

* **[!UICONTROL 已发送优惠]**：选件的发送总数。

* **[!UICONTROL 优惠展示率]**：已打开选件的数量占已发送选件数量的百分比。
...
从您的历程 **[!UICONTROL 全局报告]**，则 **[!UICONTROL 推送通知]** 选项卡详细列出了与历程中发送的推送投放相关的主要信息。
...
短信 **[!UICONTROL 全局报告]** 分为多个构件，其中详细说明了投放的成功和错误。 如果需要，可以调整每个小部件的大小并将其删除。 有关详情，请参阅此 [部分](global-report.md#modify-dashboard).
+++
