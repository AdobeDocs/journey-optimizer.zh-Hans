...
**在此页面上：**&#x200B;了解Adobe Journey Optimizer历程报告中的短信量度，包括投放和点击趋势、跟踪链接、入站消息、提供商以及退回、错误和排除原因。
...
**[!UICONTROL Campaign概述]**&#x200B;表用作历程中每个营销活动操作的短信效果仪表板。 它汇总了目标用户档案、点击和点进量度（包括排除机器人和非人类交互流量的预计点击次数）以及投放结果，例如跳出次数、发送错误和排除次数。
