...
**在此页面上：**&#x200B;了解如何在Adobe Journey Optimizer中阅读营销活动实时报告，以监控过去24小时跨电子邮件、应用程序内、推送、短信、Web和直邮渠道的实时营销活动效果。
...
您可以通过单击&#x200B;**[!UICONTROL 报告]**&#x200B;按钮，然后选择&#x200B;**[!UICONTROL 查看过去24小时报告]**，直接从营销活动访问活动实时报告。
