...
**在此页面上：**&#x200B;了解Adobe Journey Optimizer中的旅程步骤事件、它们为什么重要以及如何通过Adobe Experience Platform将其用于分析、监控和优化。
...
- **条件评估**：当配置文件通过[条件](../building-journeys/conditions.md)和决策点时
...
1. **Data Lake查询**：使用SQL查询[查询服务](https://experienceleague.adobe.com/docs/experience-platform/query/home.html?lang=zh-Hans){target="_blank"}的`journey_step_events`数据集
...
了解有关funnel analysis](query-examples.md#common-queries)的更多[查询技术。
