...
**在此页面上：**&#x200B;了解如何通过创建连接和数据视图来分析历程和消息数据，以手动配置Adobe Journey Optimizer与Customer Journey Analytics之间的集成。
...
* **从Azure数据湖存储(ADLS)同步数据[!DNL Journey Optimizer]和[!DNL Customer Journey Analytics]以便进行报告。**
