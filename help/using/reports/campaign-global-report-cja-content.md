...
title: 营销活动报告
description: 了解如何使用Campaign报告中的内容卡数据
feature: Reporting
...
# 内容卡营销活动报告 {#campaign-global-report-cja-content}

>[!BEGINSHADEBOX]

**在此页面上：**&#x200B;了解如何在Adobe Journey Optimizer中阅读内容卡促销活动报告，以分析内容卡的显示和点击趋势、跟踪数据和跟踪标签。

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

您可以访问内容卡促销活动报告，方法是单击促销活动中的&#x200B;**[!UICONTROL 报告]**&#x200B;按钮，然后选择&#x200B;**[!UICONTROL 查看所有时间报告]**。 [了解详情](report-gs-cja.md)
