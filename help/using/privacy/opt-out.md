...
**在此页面上：**&#x200B;管理收件人如何取消订阅讯息并选择退出个性化，以便您尊重他们的同意选择，并履行您的法律和品牌信誉义务。
...
<div>
<a href="../mobile/mobile-opt-out.md"><strong>短信选择退出管理</strong></a>
</div>
<p></td>
</tr></table>
...
>[!NOTE]
>
>要了解有关对象级访问控制 (OLAC) 的更多信息，请参阅[此部分](../administration/object-based-access.md)。
