...
在 [Experience Platform 文档](https://experienceleague.adobe.com/docs/experience-platform/privacy/regulations/overview.html?lang=zh-Hans#regulations)中进一步了解适用的法规。
...
>[!NOTE]
>
>此外，您还可以利用 Journey Optimizer **禁止 REST API** 来使用禁止和允许列表控制传出消息。[了解如何使用禁止 REST API](https://developer.adobe.com/journey-optimizer-apis/references/suppression/)
...
>[!NOTE]
>
>在[!DNL Journey Optimizer]中，同意由Experience Platform [同意架构](https://experienceleague.adobe.com/docs/experience-platform/xdm/field-groups/profile/consents.html?lang=zh-Hans)处理。 默认情况下，同意字段的值为空，并视为同意接收您的通信。您可以在上线时修改此默认值，使其成为[此处](https://experienceleague.adobe.com/docs/experience-platform/xdm/data-types/consents.html?lang=zh-Hans#choice-values)列出的可能值之一，或使用[同意策略](../action/consent.md)覆盖默认逻辑。
...
1. 使用[分段服务](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/overview.html?lang=zh-Hans)创建[Adobe Experience Platform受众](../audience/about-audiences.md)，并使用配置文件属性(如&#x200B;**[!UICONTROL 个性化内容=是（选择加入）]**)来定位同意个性化的用户。
...
1. 使用[分段服务](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/overview.html?lang=zh-Hans)创建一个[Adobe Experience Platform受众](../audience/about-audiences.md)。
...
1. 单击 **+** 图标并选择&#x200B;**[!UICONTROL 拆分]**&#x200B;活动，创建拆分受众。
...
1. 从此[列表](https://experienceleague.adobe.com/docs/experience-platform/xdm/data-types/consents.html?lang=zh-Hans#choice-values)中选择适当的值。
