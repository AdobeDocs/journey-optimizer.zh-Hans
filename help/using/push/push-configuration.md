...
[!DNL Journey Optimizer] 允许您创建历程并向目标受众发送消息。 开始使用 [!DNL Journey Optimizer]，您需要确保移动设备应用程序上以及Adobe Experience Platform中标记的配置和集成均已到位。 要了解 [!DNL Adobe Journey Optimizer] 请参阅 [本页](push-gs.md).
...
在创建移动设备应用程序之前，您首先需要确保在Adobe Experience Platform中拥有或分配了正确的标记用户权限。 在 [标记文档](https://experienceleague.adobe.com/docs/experience-platform/tags/admin/user-permissions.html){target=&quot;_blank&quot;}。
...
1. 从 **[!UICONTROL Permissions]** 选项卡，选择 **[!UICONTROL Property rights]**.
...
技术设置涉及应用程序开发人员与业务管理员之间的密切协作。 开始发送推送通知之前 [!DNL Journey Optimizer]，您需要在 [!DNL Adobe Experience Platform Data Collection] 并将您的移动设备应用程序与Adobe Experience Platform Mobile SDK相集成。

按照以下链接中详细描述的实施步骤操作：

* 对于 **Apple iOS**:了解如何在 [Apple文档](https://developer.apple.com/documentation/usernotifications/registering_your_app_with_apns){target=&quot;_blank&quot;}
...
Adobe Experience Platform Mobile SDK通过Android和与iOS兼容的SDK为您的手机提供客户端集成API。 关注 [Adobe Experience Platform Mobile SDK文档](https://aep-sdks.gitbook.io/docs/getting-started/overview){target=&quot;_blank&quot;}，以在您的应用程序中通过Adobe Experience Platform Mobile SDK进行设置。
...
## 步骤2:在您的移动资产中配置Adobe Journey Optimizer扩展 {#configure-journey-optimizer-extension}
...
了解如何在 [Adobe Experience Platform Mobile SDK文档](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-journey-optimizer){target=&quot;_blank&quot;}。
...
1. 输入 **[!UICONTROL Display Name]** 和 **[!UICONTROL Description]**. 单击 **[!UICONTROL Add field groups]** 完成时。 有关如何创建字段组的更多信息，请参阅 [XDM系统文档](https://experienceleague.adobe.com/docs/experience-platform/xdm/tutorials/create-schema-ui.html){target=&quot;_blank&quot;}。
...
1. 在 **[!UICONTROL Event ID type]** 字段，选择 **[!UICONTROL Rule Based]**.
...
1. 单击 **[!UICONTROL Ok]** then **[!UICONTROL Save]**.
...
1. 在右侧显示的配置窗格中编辑历程的属性。 在中了解详情 [部分](../building-journeys/journey-gs.md#change-properties).
...
现在，您已准备好通过Journey Optimizer发送推送通知。
