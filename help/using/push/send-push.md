...
**在此页面上：**&#x200B;了解如何在Adobe Journey Optimizer中预览、验证和发送推送通知。
...
* 单击&#x200B;**[!UICONTROL 模拟内容]**，然后从下拉列表中选择&#x200B;**[!UICONTROL 模拟内容（AEP配置文件）]**&#x200B;以使用测试配置文件进行预览。 然后，您可以选择预览内容的设备类型： **[!UICONTROL iOS]**、**[!UICONTROL Android]**&#x200B;或&#x200B;**[!UICONTROL Web]**。
