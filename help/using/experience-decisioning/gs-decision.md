...
**在此页面上：**&#x200B;比较Journey Optimizer中的决策和决策管理功能，以便选择合适的方法来跨渠道提供个性化优惠。
...
>[!NOTE]
>
>要从决策管理迁移到决策，请参阅[迁移文档](../experience-decisioning/migrate-to-decisioning.md)和[迁移API指南](../experience-decisioning/decisioning-migration-api.md)。
