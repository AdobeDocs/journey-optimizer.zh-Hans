...
**在此页面上：**&#x200B;了解如何在Adobe Experience Platform中收集有关展示次数、点击量和自定义事件的决策反馈，以便您能够为决策报表、上限规则和AI排名模型提供支持。
...
* 构成[决策报告](../cja-reporting.md)；
* 使用[上限](../items.md#capping)规则；
* 正在生成可用作排名方法的[AI模型](../ranking/ai-models.md)。
...
每次Decisioning做出决策时，与该决策事件相关的信息都&#x200B;**自动发送到Adobe Experience Platform**。<!--TBC + link-->
