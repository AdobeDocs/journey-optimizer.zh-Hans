...
* 在“创建表单预设”部分中添加了注释，以指定要在选择下拉列表中显示的流连接要求。 [了解详情](../landing-pages/lp-forms.md)

* 现在，Experience Decisioning部分中提供了有关如何配置数据收集以跟踪展示次数、点击量和自定义事件的新页面。 [了解详情](../experience-decisioning/data-collection/schema-requirement.md)
