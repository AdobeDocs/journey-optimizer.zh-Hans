...
<thead>
<tr>
<th><strong>向用户发送短信（正式发布版）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
<thead>
<tr>
<th><strong>基于属性的访问控制（限量发布版）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
<td>
<p>Adobe Stock 和 Adobe Journey Optimizer 电子邮件设计器集成插件为客户提供一种简单的方式来导航、许可和保存图像，以便用于消息创作。</br> 使用全新的<b>查找类似 Stock 照片</b>选项，您可查找与图像的内容、颜色和构成相匹配的 Stock 照片。 </p>
