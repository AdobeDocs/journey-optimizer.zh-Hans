...
>[!NOTE]
>
>这些发行说明中列出的功能包括&#x200B;**可用日期**，该日期指示每个更改何时可在您的环境中访问。 标记为&#x200B;**即将推出**&#x200B;的条目计划在未来几天或几周内发布。 这些部分中的信息可能会发生更改。

## 2026年5月发行说明 {#may-26-rn}

### 历程 {#may-26-journeys}

在此版本中，历程中添加了以下功能和改进。 预计在接下来的几天或几周内还将进行其他更改 — 请参阅下面的[即将推出](#may-26-journeys-coming-soon)部分。
...
以下历程功能预计将在未来几天或几周内推出。 信息可能会发生更改。
...
此版本中的编排活动中添加了以下功能和改进。 预计在接下来的几天或几周内还将进行其他更改 — 请参阅下面的[即将推出](#may-26-oc-coming-soon)部分。
...
预计未来几天或几周内，将推出以下精心设计的营销活动功能。 信息可能会发生更改。
...
预计将在未来几天或几周内进行以下营销活动改进 — 请参阅下面的[即将推出](#may-26-campaigns-coming-soon)部分。

#### 即将推出 {#may-26-campaigns-coming-soon}

预计未来几天或几周内，将进行以下营销活动改进。 信息可能会发生更改。
...
在此版本中，Decisioning中添加了以下功能和改进。 预计在接下来的几天或几周内还将进行其他更改 — 请参阅下面的[即将推出](#may-26-decisioning-coming-soon)部分。
...
此版本中的电子邮件渠道添加了以下功能和改进。 预计在接下来的几天或几周内还将进行其他更改 — 请参阅下面的[即将推出](#may-26-email-coming-soon)部分。
...
未来几天或几周内，预计将会出现以下电子邮件渠道改进。 信息可能会发生更改。
...
* **字符数** — 您现在可以使用字符数实时监控SMS消息的长度。 它有助于您了解消息何时会被拆分为多个片段，以便更好地管理格式并避免发送成本意外增加。 [了解详情](../mobile/create-mobile-message.md)
...
<thead>
<tr>
<th><strong>集成（正式发布）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
预计未来几天或几周内将进行以下管理改进 — 请参阅下面的[即将推出](#may-26-admin-coming-soon)部分。

#### 即将推出 {#may-26-admin-coming-soon}

未来几天或几周内，预计将会出现以下管理改进。 信息可能会发生更改。
...
预计在未来几天或几周内将实现以下报告改进 — 请参阅下面的[即将推出](#may-26-reporting-coming-soon)部分。

#### 即将推出 {#may-26-reporting-coming-soon}

预计未来几天或几周内将实现以下报告改进。 信息可能会发生更改。
