...
>[!TIP]
>
>不熟悉历程进入和退出标准？ 从我们的[历程进入和退出标准综合指南](entry-exit-criteria-guide.md)开始，该指南包括实际用例、最佳实践和分步配置指南。
...
浏览视频教程，了解使用[!DNL Adobe Journey Optimizer]构建最常见用例的关键步骤。
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <br/>
      <strong>客户入门</strong><br/><p>了解如何在 Journey Optimizer 中实施客户引导历程。</p> - <a href="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/use-cases/customer-onboarding" target="_blank">观看用例视频</a>
    </td>
    <td>
      <img src="../assets/do-not-localize/icon-campaign.svg" width="35px">
    <br/>
      <strong>放弃的购物车</strong><br/><p>了解如何使用[!DNL Adobe Journey Optimizer]中的行动手册功能实施放弃的购物车用例。</p><a href="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/tutorials/use-cases/abandoned-cart" target="_blank">观看用例视频</a>
    </td>
    <td>
  ...
  <tr style="border: 0;">
    ...
    <br/>
      <strong>实时优惠个性化</strong><br/><p>通过在[!DNL Adobe Journey Optimizer]中使用与天气相关的数据来提供选件，企业可以根据实时的真实环境条件来个性化客户体验。</p><a href="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction" target="_blank">按照分步教程进行操作</a>
    </td>
    <td>
      <img src="../assets/do-not-localize/icon-configure.svg" width="35px">
    <br/>
      <strong>跟踪和报告通过决策提供的优惠</strong><br/><p>为通过[!DNL Adobe Journey Optimizer]交付的选件启用报表和性能分析：当根据上下文信号个性化并交付选件时，必须跟踪展示次数和用户交互以评估其有效性。</p><a href="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/reporting-on-ajo-od/introduction" target="_blank">按照分步教程进行操作</a> 
    </td>
    <td>
      <img src="../assets/do-not-localize/icon_profile-audience.svg" width="35px">
    <br/>
      <strong>使用排名公式个性化优惠</strong><br/><p>了解如何通过利用[!DNL Adobe Journey Optimizer]中的用户属性（如邮政编码和年收入）来提供个性化的财务优惠。 通过使用排名公式，可以根据特定于位置的促销活动以及基于收入的资格，对优惠进行智能评分和优先排序。</p><a href="https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction" target="_blank">按照分步教程进行操作</a> 
    </td>
  </tr>
</table>

另请参阅[在 [!DNL Adobe Journey Optimizer]](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction){target="_blank"}中将编排扩展到全渠道参与的视频教程：在六个课程中，您将学习如何提升业务通信，从简单的出站消息传送提升到复杂的全渠道体验。 通过实际示例，您可以深入了解如何创建将主动外联与响应式参与无缝结合的客户历程。
