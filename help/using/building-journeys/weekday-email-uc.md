...
在历程开始后，添加一个条件以检查当天是星期六还是星期日。 这将相应地分支工作流。
...
1. 选择&#x200B;**一周中的某天**&#x200B;作为时间过滤选项。

1. 对于&#x200B;**第一个路径（星期六）**，仅选择&#x200B;**星期六**。 将此路径标记为“星期六”。

1. 单击&#x200B;**[!UICONTROL 添加路径]**&#x200B;以创建第二个条件。

1. 对于&#x200B;**秒路径（星期日）**，选择&#x200B;**一周的某天**，然后选择&#x200B;**仅星期日**。 将此路径标记为“Sunday”。
...
1. 在&#x200B;**工作日路径**（“其他案例”路径）中，直接继续添加&#x200B;**[!UICONTROL 电子邮件]**&#x200B;操作活动。 工作日条目不需要等待活动。

1. 根据需要配置电子邮件。

### 步骤5：完成历程流

在星期六和星期日路径上的等待活动后，所有三个路径（星期六、星期日和工作日）都应流向相同的电子邮件操作活动。 在电子邮件后添加&#x200B;**[!UICONTROL 结束]**&#x200B;活动。
...
* **开始** → **条件：是星期六还是星期日？**
   * **是（星期六）：**&#x200B;等到星期一上午9:00→发送电子邮件
   * **是（星期日）：**&#x200B;等到星期一上午9:00→发送电子邮件
   * **否（星期一至星期五）：**&#x200B;立即发送电子邮件
