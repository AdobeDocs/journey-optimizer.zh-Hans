...
集合中定義的元素會使用特定函式來參照 `all`， `first` 和 `last`. 有关详细信息，请参见[此页面](../expression/collection-management-functions.md)。
...
如果您從外部資料來源選取欄位，需要呼叫引數，右側會出現一個新索引標籤，可讓您指定此引數。 请参阅[此页](../expression/expressionadvanced.md)。
