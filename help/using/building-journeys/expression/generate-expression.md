...
* **TL；DR：**&#x200B;本页介绍如何在历程高级表达式编辑器中使用AI从纯语言提示生成有效的旅程表达式。

**意图：**

* 使用人工智能从自然语言描述生成历程表达式
...
* **使用AI生成表达式**：嵌入到历程高级表达式编辑器中的AI支持的生成功能，可将纯语言提示转换为有效的旅程表达式&#x200B;*（产品特定）*
...
* 规范名称：使用AI生成表达式 — 首字母缩略词：none — 变体：AI表达式生成、历程表达式生成
* 同义词： &quot;使用AI生成表达式&quot; = &quot;AI表达式生成器&quot;
* 请勿混淆：使用AI （AI支持的生成器）≠高级表达式编辑器（手动代码编辑器本身）生成表达式

**常见问题解答：**

* **问：在哪里可以使用AI生成表达式？**  — 无论在何处打开历程高级表达式编辑器（包括“条件”活动、“优化”活动和具有自定义日期的“等待”活动），它都可用。
