...
>title="创建历程"
>abstract="借助 **[!DNL Adobe Journey Optimizer]**，可以利用存储在事件或数据源中的上下文数据构建实时编排用例。"
...
在[本节](entry-management.md#journey-processing-rate)中了解有关配置文件如何流过历程和历程处理率的更多信息。
...
* Journey Optimizer附带[内置消息](../building-journeys/journey-action.md)功能。 如果您使用第三方系统来发送消息，则可以&#x200B;**创建自定义操作**。 在此[部分](../action/action.md)中了解详情。
