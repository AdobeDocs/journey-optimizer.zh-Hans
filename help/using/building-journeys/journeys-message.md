...
所有“每周时间”中的排名都介于–83到84之间，但为了避免将具有168个不同值的配置文件打乱，这些排名会合并为一个值。 对于三组168分中的每组，排名从–83升至84。

该值由优化算法读取。 此值并非设计为人类可读。

排名越高，选择与收件人交互的时间就越好。 由于您可以定义历程的开始和持续时间，因此最佳排名(84)可能不会落入该时间范围内。 在这种情况下，我们建议选择具有最高排名值的小时。
+++
