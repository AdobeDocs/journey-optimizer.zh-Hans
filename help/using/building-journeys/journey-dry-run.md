...
* **读取受众**&#x200B;具有计划执行时间（每天、每周或每月）的活动不遵循历程中配置的时间 — 计划锚定到激活练习的那一刻。 例如，如果您的旅程设置为每天上午10点运行，但您在上午8点激活了练习，则练习期间的所有后续计划读取都会在早上8点执行。
...
**在练习中，读取受众活动的计划执行时间是否发生更改？**

是的。 对于使用具有计划时间（每天、每周或每月）的&#x200B;**读取受众**&#x200B;活动的历程，练习会将计划锚定到激活练习的时刻，而不是历程中配置的时间。 例如，如果历程设置为在上午10点运行，但您在上午8点激活了练习，则练习期间的所有每日读取都会在上午8点执行。
