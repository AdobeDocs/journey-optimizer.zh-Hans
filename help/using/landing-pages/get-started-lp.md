...
* 允许客户&#x200B;**从电子邮件或营销活动中的链接**&#x200B;选择加入或选择退出营销通信或特定服务或新闻稿
...
1. [**测试和发布**](manage-lp.md) — 预览页面，测试表单行为，然后发布以使其上线。
...
* 快速无缝地设置&#x200B;**选择加入和选择退出流程**，包括订阅列表以允许用户选择加入或选择退出特定服务。 [了解详情](lp-use-cases.md#subscription-to-a-service)
