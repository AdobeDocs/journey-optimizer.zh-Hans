...
要为基于代码的渠道启用报告，您需要确保在应用程序实施[数据流](../data/get-started-datasets.md)中使用的[数据集](https://experienceleague.adobe.com/docs/experience-platform/datastreams/overview.html){target="_blank"}也包含在报告配置中。
