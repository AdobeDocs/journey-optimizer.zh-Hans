...
### 创建挑战* 从简单的开始，迎接您的第一个挑战* 在发布到生产环境之前进行全面测试* 确保就要求和奖励进行明确的沟通* 设置现实的时间安排，让客户能够完成挑战

### 管理和监测* 定期检查挑战性能（至少每周检查一次实时挑战）* 使用描述性名称指示目的、受众或时间段* 为组织应用一致的标记* 存档完成的难题以保持库存的可管理性
...
* [创建挑战](create-challenges.md) — 构建新的忠诚度挑战
