...
>title="内容实验"
>abstract="您可以选择更改投放内容、主题或发件人，以定义多种投放处理方式并确定适用于受众的最佳组合。"

>[!AVAILABILITY]
>
>的 **内容实验** 功能当前仅适用于一组组织（有限可用性）。 有关更多信息，请联系您的Adobe代表。

使用Journey Optimizer内容实验定义多种交付处理。 兴趣的受众被随机分配给每个治疗，以便确定哪个治疗在兴趣量度方面表现最佳。 您可以选择更改投放内容、主题或发件人。

>[!NOTE]
>
>在开始内容实验之前，请确保为自定义数据集设置了报表配置。 在 [此部分](reporting-configuration.md).
...
1. 选择您的渠道，然后选择 **[!UICONTROL Surface]** 要用于此投放。 有关更多信息，请参阅 [通道曲面](../configuration/channel-surfaces.md) 页面。
...
1. 定义要定位的受众。 为此，请单击 **[!UICONTROL Select audience]** 按钮以显示可用Adobe Experience Platform区段列表。 [了解有关区段的更多信息](../segment/about-segments.md)
   ...
   在 **[!UICONTROL Identity namespace]** 字段中，选择要用于识别选定区段中个人的命名空间。 [了解更多](get-started-experiment.md#content-experiment-work)

1. 要在特定日期或定期频率执行营销活动，请配置计划部分。 [了解更多](create-campaign.md)
...
1. 从 **[!UICONTROL Edit content]** 窗口中，开始个性化您的治疗A。

   对于这种处理，我们将直接在主题行中指定特价。

   ![](assets/content_experiment_5.png)

1. 在设计您的第一个治疗方案后， **[!UICONTROL More actions]** 按钮，单击 **[!UICONTROL Duplicate]**.

   您还可以选择从头开始单击 **[!UICONTROL Content experiment]** 按钮 ![](assets/content_experiment_16.png) 访问高级选项，然后 **[!UICONTROL Add treatment]**.
...
1. 根据需要将第二次处理个性化。
   ...
   在此，我们选择不在 **[!UICONTROL Subject line]**.
...
>[!AVAILABILITY]
>
>内容实验功能当前仅适用于一组组织（有限可用性）。 有关更多信息，请联系您的Adobe代表。
...
* **[!UICONTROL Confidence interval]**:基线与最佳处理之间性能差异的百分比。 [了解更多](../campaigns/experiment-calculations.md#confidence-intervals).

* **[!UICONTROL Average lift]**:给定治疗相对于基准线的转化率提高的百分比。 [了解更多](../campaigns/experiment-calculations.md#understand-lift)

* **[!UICONTROL Confidence]**:有证据表明，给定治疗与基准治疗相同。 [了解更多](../campaigns/experiment-calculations.md#understand-confidence)
