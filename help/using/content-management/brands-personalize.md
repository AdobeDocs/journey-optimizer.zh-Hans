...
**在此页面上：**&#x200B;了解如何通过在Adobe Journey Optimizer中定义品牌标识、写作风格和视觉内容规则，使您的品牌指南个性化。
...
1. 选择一个示例以更新图像、替换图像或单击![Dive image alt text](assets/do-not-localize/Smock_Delete_18_N.svg "Delete")图标以删除图像。
