...
>[!CAUTION]
>
>由于&#x200B;**草稿**&#x200B;和&#x200B;**实时**&#x200B;状态已在Journey Optimizer 2024年6月版本中引入，因此在此版本之前创建的所有片段都具有&#x200B;**草稿**&#x200B;状态，即使它们在历程或营销活动中使用也是如此。 如果您对这些片段进行任何更改，则需要发布片段以使其成为&#x200B;**实时**&#x200B;片段，并将更改传播到相关的活动和历程。您还需要创建一个新的历程/活动版本并发布它。发布需要[发布片段](../administration/ootb-product-profiles.md#content-library-manager)用户权限。
