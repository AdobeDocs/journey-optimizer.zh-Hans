...
行动是指您通过这些连接向客户提供个性化的实时体验，例如推送通知、电子邮件或您在业务中使用的任何其他数字互动方式。
...
这些操作在历程的左侧面板中可用，位于 **[!UICONTROL 操作]** 类别。 请参阅[此页](../building-journeys/about-journey-activities.md#action-activities)。
