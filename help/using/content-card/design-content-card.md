...
1. 在&#x200B;**[!UICONTROL 目标]**&#x200B;字段中，输入Web URL或深层链接，用户在与按钮交互后将定向到该链接。
...
在&#x200B;**[!UICONTROL 目标URL]**&#x200B;字段中，输入Web URL或深层链接，在用户与内容卡交互后，这些链接会将用户定向到所需的目标。 这可以是外部网站、应用程序中的特定页面，或者您希望用户根据其交互情况被带往的任何其他位置。
