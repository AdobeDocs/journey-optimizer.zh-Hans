...
1. 在字段组列表中，将光标置于“字段组A”上，然后单击 **[!UICONTROL 复制]** 图标。 例如，将复制的字段组命名为“字段组B”。
1. 在“字段组B”中，删除您不再需要的字段。
1. 在“字段组A”中，检查此字段组的使用位置。 此信息显示在 **[!UICONTROL 使用位置]** 字段。
1. 打开所有使用“字段组A”的历程。
