...
1. 在&#x200B;**[!UICONTROL 消息文本]**&#x200B;或&#x200B;**[!UICONTROL 描述]**&#x200B;字段中，输入消息内容。 您可以使用个性化定制每个用户档案的文本。 请注意，字符限制因消息类型而异：富媒体（单个）为3,072个字符，基本RCS为160个字符。
...
>title="定义 SMS 内容"
>abstract="使用个性化编辑器自定义并本地化您的移动设备消息，以定义内容并增强动态元素。"
...
1. 选择&#x200B;**[!UICONTROL Url]**&#x200B;并单击&#x200B;**[!UICONTROL 添加URL]**。 在[本节](../personalization/functions/helpers.md#url)中了解有关`Url`帮助程序函数的更多信息。
...
1. 要添加可在您的移动设备应用程序中打开特定屏幕的深层链接，请将`Url`帮助程序函数与`DEEPLINK`类型一起使用，如下面的示例所示。 [了解有关深层链接的更多信息](../email/deeplinks.md)
   ...
   >[!CAUTION]
   >
   >在使用深层链接之前，请确保您已在Journey Optimizer中完成相应的[配置步骤](../email/deeplinks.md#configuration)，并在移动设备应用程序中实施了[深层链接处理](../email/deeplinks.md#mobile-implementation)。 如果您尚未这样做，则深层链接不会将用户定向到所需的应用程序内内容。
   >
