...
>title="委派移动设备消息子域"
>abstract="为移动设备消息设置您的子域。 可使用已委派给 Adobe 的子域或配置新的子域。"

>[!CONTEXTUALHELP]
>id="ajo_admin_subdomain_sms"
>title="委派移动设备消息子域"
>abstract="您必须为移动设备消息配置一个子域，因为创建 SMS 配置时需要使用该子域。 可使用已委派给 Adobe 的子域或配置新的子域。"
...
若要能够缩短添加到SMS/RCS/MMS消息的URL，您必须设置在[创建SMS配置](mobile-configuration.md#sms-prerequisites)时将选择的子域。
...
在使用子域发送SMS消息之前，必须等待Adobe执行所需的检查，最多可能需要4小时。<!--Learn more in [this section](#subdomain-validation).--> 检查成功后，子域将获得&#x200B;**[!UICONTROL Success]**&#x200B;状态。 它可用于创建短信渠道配置。
