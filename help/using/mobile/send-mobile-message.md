...
title: 检查并测试您的移动消息
description: 了解如何在Journey Optimizer中检查和发送移动消息
feature: SMS
...
# 检查并发送您的移动消息 {#send-sms}

>[!BEGINSHADEBOX]

**在此页面上：**&#x200B;了解如何在Adobe Journey Optimizer中预览、验证和发送移动消息，包括检查字符编码和限制以及在投放之前解决警报。

>[!ENDSHADEBOX]

## 预览您的移动消息 {#preview-sms}
...
从&#x200B;**[!UICONTROL Simulate content]**&#x200B;访问任一模拟方法时会显示字符计数，以协助规划和管理移动消息。
...
>
>要了解最大程度地减少短信计费超额的最佳实践，请参阅[用于字符优化的短信最佳实践](mobile-cost-optimization.md)。
...
* **警告**&#x200B;参考推荐和最佳实践。 例如，如果您的移动设备消息为空或动态内容可能超过字符限制，则会显示警告消息。
...
>[!IMPORTANT]
>
> 如果您的营销活动受批准政策的约束，则需要请求批准才能发送移动消息。 [了解详情](../test-approve/gs-approval.md)

当您的手机消息就绪后，完成您的[历程](../building-journeys/journey-gs.md)或[营销活动](../campaigns/create-campaign.md)的配置以发送该消息。

**相关主题**

* [配置短信渠道](mobile-configuration.md)
* [SMS/RCS/MMS报告](../reports/journey-global-report-cja-sms.md)
* [创建移动设备消息](create-mobile-message.md)
