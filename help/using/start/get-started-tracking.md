...
* **设置URL跟踪参数** — 在表面级别配置跟踪参数以自动附加营销活动标识符（utm_campaign、utm_source等） 到所有电子邮件链接。 这支持在整个数字生态系统中进行归因跟踪。 [了解详情](../email/url-tracking.md)
...
* **定义自定义成功量度** — 根据您的业务目标（购买、注册、续订等）配置特定KPI 超出标准参与量度。 [了解详情](../building-journeys/success-metrics.md)
