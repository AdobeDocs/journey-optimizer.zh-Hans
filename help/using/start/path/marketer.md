...
1. **创建受众**。Journey Optimizer 允许通过区段定义直接从&#x200B;**受众**&#x200B;菜单创建受众，并将其用于历程。要了解有关受众的更多信息，请参阅[此页面](../../audience/about-audiences.md)。[在此示例中](../../audience/creating-a-segment-definition.md)了解如何构建区段定义。
...
1. **设计客户历程**，以提供个性化的情境式体验。[!DNL Journey Optimizer] 使您可以利用存储在事件或数据源中的上下文数据，生成实时编排用例。设计由以下功能提供支持的分步式高级方案：
   ...
   * 使用&#x200B;**内置渠道操作**（电子邮件、短信、推送、InApp）发送在[!DNL Journey Optimizer]中设计的消息；或者，如果您使用第三方系统发送消息，则创建&#x200B;**自定义操作**。
