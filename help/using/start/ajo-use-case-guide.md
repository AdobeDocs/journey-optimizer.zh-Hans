...
**您将生成：**&#x200B;自动欢迎系列，该系列会向每个新订阅者问候并推播不活动的订阅者。**最适合：**&#x200B;营销人员· **功能：**&#x200B;事件触发的历程
...
**您将生成：**&#x200B;自动恢复流程，提醒客户留下的项目。**最适合：**&#x200B;营销人员· **功能：**&#x200B;事件触发的历程
...
**您将生成：**&#x200B;由外部系统触发的按需订单、送货或约会确认。**最适合：**&#x200B;营销人员和开发人员· **功能：**&#x200B;由外部系统触发的营销活动
...
**您将生成：**&#x200B;自动选择表现最佳内容的计划促销活动。**最适合：**&#x200B;营销人员· **功能：**&#x200B;计划的营销活动+内容试验
...
**您将生成：**&#x200B;一个向每位客户显示单个最佳优惠的决定。**最适合：**&#x200B;营销人员· **功能：**&#x200B;决策
...
有关与决策树和功能表的详细比较，请参阅[历程与促销活动：选择正确的方法](journeys-vs-campaigns.md)。 确定历程后，请参阅[历程类型：选择正确的类型](../building-journeys/journey-types-selection.md)，以便在单一事件、读取受众、受众资格和业务活动历程之间进行选择。
