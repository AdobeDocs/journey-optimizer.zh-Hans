...
* **Personalization** — 在Personalization编辑器中，生成新表达式、解释现有代码或修复AI助手的问题。 用于Personalization表达式的[AI助手](../content-management/generative-personalization-expressions.md)
...
[查看所有可用的行动手册](https://experienceleague.adobe.com/docs/experience-platform/use-case-playbooks/playbooks/playbooks-list.html?lang=zh-Hans){target="_blank"} | [在Experience Platform文档中了解详情](https://experienceleague.adobe.com/docs/experience-platform/use-case-playbooks/playbooks/overview.html){target="_blank"}
