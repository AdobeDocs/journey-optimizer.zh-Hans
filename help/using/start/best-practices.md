...
**在此页面上：**&#x200B;将Journey Optimizer最佳实践应用于身份拼接、全渠道个性化和历程护栏，以使您可构建可靠的用例，并在系统限制内有效扩展。
...
1. 品牌希望在放弃（例如，放弃的购物车电子邮件）30分钟后重新吸引网站访客：
...
* 如果您即将达到实时历程的限制，可以采取的第一个步骤是转到&#x200B;**历程**&#x200B;下的&#x200B;**概述**&#x200B;选项卡，以查看过去24小时内有多少具有活动配置文件的历程处于活动状态。 您可以在此部分中检查进入和退出历程的用户档案数，以确定这一点。
