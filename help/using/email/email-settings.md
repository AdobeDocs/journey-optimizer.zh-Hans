...
* 对于批次历程，不适用于在进行电子邮件表面配置完成之前已启动的批次执行。 更改将在下一次重复执行或新的执行时生效。
...
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/configuration/monitor-reputation/retries.html?lang=" text="关于重试"
