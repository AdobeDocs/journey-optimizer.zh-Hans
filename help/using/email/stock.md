...
使用 [!DNL Adobe Journey Optimizer]，则您可以从 [!DNL Adobe Stock] 并将其添加到 **[!UICONTROL Assets]** 文件夹 **[!UICONTROL Find Adobe Stock photos]** 选项。 此外， **[!UICONTROL Find Similar Stock photos]** 选项可帮助您查找与投放中所用资产的内容、颜色和组成相匹配的图像。

## 权限{#stock-permissions}

的 **[!UICONTROL Find Adobe Stock photos]** 和 **[!UICONTROL Find Similar Image]** 有权访问AEM Assets Essentials产品配置文件的用户可以使用相应选项。
...
1. 从 [!DNL Adobe Stock] 网站，您需要购买资产才能下载图像并删除水印。
   ...
   此购买取决于您的Adobe Stock计划或订阅。 请注意，如果您有多个Adobe Stock帐户，您将被重定向到上次使用的Stock ID。 在这种情况下，请确保您在获得资产许可之前已登录到正确的帐户。
