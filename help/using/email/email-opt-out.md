...
如果您已切换 **[!UICONTROL 启用List-Unsubscribe]** 选项取消订阅列表头，我们建议您启用这两种方法 —  **Mailto（取消订阅）** 和 **一键式取消订阅URL**. 并非所有电子邮件客户端都支持HTTP方法。 利用提供的Mailto list-unsubscribe功能，您可以选择替代方案，可以更好地保护发件人的信誉，并且所有收件人都能够使用取消订阅功能。 [了解详情](email-settings.md#list-unsubscribe)
