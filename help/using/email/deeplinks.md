...
title: 在电子邮件中使用深层链接
description: 了解如何向电子邮件内容添加深层链接，以及如何在iOS和Android应用程序中实施深层链接处理。
feature: Email
topic: Content Management
role: User, Developer
level: Intermediate
keywords: 深层链接，深层链接，通用链接，应用程序链接，电子邮件
...
# 在电子邮件中配置深层链接 {#email-deeplinks}

电子邮件中的深层链接可帮助您将收件人从电子邮件引导至移动应用程序中的特定屏幕或内容。 它有助于将用户直接引导至所需的应用程序内体验，而无需通过Web浏览器或应用商店路由他们，因此该历程始终相关且符合品牌要求。

若要向电子邮件添加深层链接，请确保已启用[链接跟踪](message-tracking.md#enable-tracking)。 在Email Designer中选择要链接的元素（文本、按钮或图像），在上下文工具栏中单击&#x200B;**[!UICONTROL 插入链接]**，然后选择&#x200B;**[!UICONTROL 深层链接]**&#x200B;以输入深层链接URL。 [了解有关插入链接的更多信息](message-tracking.md#insert-links)
...
要在移动设备应用程序的电子邮件中使用深层链接，请完成以下配置步骤。
...
>[!IMPORTANT]
>
>启用[链接跟踪](message-tracking.md#enable-tracking)时，通过Adobe电子邮件基础架构进行深层链接适用。 跟踪的深层链接点击使用`/ee/v1/mclick/*`下的URL，Adobe会托管这些URL并对其进行解析。
>
...
为消息启用[链接跟踪](message-tracking.md#enable-tracking)后，[!DNL Journey Optimizer]将继续跟踪这些点击，将它们包含在报表中，并且如果对消息运行这些点击，则可以在[内容实验](../content-management/content-experiment.md)中使用它们。
...
* 安装并打开应用程序至少一次后，应用程序链接/通用链接行为才最可靠。
