...
title: 在Email Designer中协作处理电子邮件内容
description: 了解如何在Journey Optimizer中使用Email Designer中的协作工具添加评论、标记审阅者并跟踪关于您的电子邮件的反馈。
feature: Email Design
topic: Content Management
role: User
level: Beginner, Intermediate
keywords: 电子邮件、协作、评论、审阅、脉冲通知
...
电子邮件Designer右侧导航中的![Collaboration图标](assets/email_designer_collaboration_icon.png){width="90%"}
...
1. 选择要为通知添加的名称。 添加您希望在邀请中包括的任意数量的协作者或审阅人。
   ...
   ![带标记的审阅者的邀请面板](assets/email_designer_collaboration_comment.png){width="90%"}
...
1. 单击工具栏中的&#x200B;**[!UICONTROL Collaboration]**&#x200B;工具。
   ...
   组件工具栏中的![Collaboration工具图标](assets/email_designer_collaboration_component_comment.png){width="80%"}
...
![回复和引号回复的更多菜单选项](assets/email_designer_collaboration_actions.png){width="100%"}

## 解决评论 {#resolve-comments}

作为作者或设计者，评估审阅人的反馈并确定要进行的更改。 完成更改并满足请求后，单击&#x200B;**[!UICONTROL 更多菜单]** (...)图标，然后选择&#x200B;**[!UICONTROL 解决]**。

![回复和引号回复的更多菜单选项](assets/email_designer_collaboration_resolve.png){width="100%"}
...
![更多菜单选项可在设计组件上放置注释](assets/email_designer_collaboration_place_comment.png){width="60%"}
...
![用于显示已解析评论的筛选器选项](assets/email_designer_collaboration_filter.png){width="60%"}

已解析的注释包括&#x200B;**[!UICONTROL Unresolve]**&#x200B;图标。 如果您确定未解析注释/线程且需要进一步更改，请单击图标以删除&#x200B;**[!UICONTROL 已解析]**&#x200B;标记。

已解析评论上的![取消解析图标](assets/email_designer_collaboration_unresolve.png){width="60%"}
