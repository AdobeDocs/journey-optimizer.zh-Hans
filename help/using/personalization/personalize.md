...
在&#x200B;**[!UICONTROL Personalization编辑器]**&#x200B;中或从Email Designer工具栏（**[!UICONTROL 添加表达式]**）中，**[!UICONTROL 生成内容]**&#x200B;可帮助您从自然语言生成新表达式、说明现有代码的用途，并修复选择中的问题，然后当输出与您的意图匹配时应用输出。

![](../content-management/assets/ai-perso-generate.png)

➡️ [了解如何使用生成个性化表达式的内容](../content-management/generative-personalization-expressions.md)
...
本页介绍Journey Optimizer中的个性化 — 基于Handlebars的个性化编辑器的工作方式、它使用的数据、交互式游乐场、为表达式生成内容以及在电子邮件Designer和推送编辑器中编辑内联属性。
...
* **生成内容（个性化表达式）**：个性化编辑器和电子邮件Designer中的一个AI工具，它从自然语言生成个性化表达式，解释现有代码并修复选择中的问题。 *（产品特定）*
