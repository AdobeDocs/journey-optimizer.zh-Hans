...
1. 如果您选择了 **[!UICONTROL Push Notification]** 渠道，请至少选择一个平台(**iOS** 和/或 **Android**)，并选择要用于每个平台的移动应用程序。
...
1. 如果您选择了 **[!UICONTROL SMS]** 渠道，按照 [此部分](sms-configuration.md#message-preset-sms).
