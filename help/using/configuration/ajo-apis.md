...
**在此页面上：**&#x200B;了解如何访问、验证和使用Adobe Journey Optimizer RESTful API（包括决策管理和Experience Decisioning API）以编程方式执行关键操作。
...
* [Adobe Journey Optimizer API参考](https://developer.adobe.com/journey-optimizer-apis){target="_blank"}
