...
**在此页面上：**&#x200B;了解为何以及何时必须为您在 Adobe Journey Optimizer 中委托给 Adobe 的子域设置 DMARC 记录，以符合 Google 和 Yahoo 的发件人要求。
...
>abstract="作为其执行行业最佳做法的一部分，自 **2024 年 2 月 1 日**&#x200B;起，Google 和 Yahoo 均要求您为用于向其发送电子邮件的任何域配置 **DMARC 记录**。<br>因此，您必须确保已为在 Journey Optimizer 中委托给 Adobe 的所有子域配置 DMARC 记录。"
