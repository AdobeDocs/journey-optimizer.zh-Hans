...
**在此页面上：**&#x200B;了解为什么以及如何在Adobe Journey Optimizer中设置电子邮件发送子域，并比较完全委派、CNAME和自定义委派方法以保护您的域信誉和可投放性。
...
| 配置方法 | 工作原理 | 工作量 |
|---|---|---|
| **完全委派** | 创建子域和命名空间记录。 然后，Adobe将配置Adobe Journey Optimizer所需的所有DNS记录。<br/><br/>在此设置中，Adobe完全负责管理子域和所有DNS记录。 | 低 |
