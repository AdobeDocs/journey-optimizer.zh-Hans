...
|消息|<ul><li> **[!DNL Manage messages]**:读取、创建、编辑消息和登陆页面并发送测试/校样。</li><li>**[!DNL Manage messages preview and test]**:读取、创建、编辑消息/登陆页面预览并发送测试/校样。</li><li>**[!DNL Publish messages]**:发布消息和登陆页面。</li><li>**[!DNL View messages report]**:阅读和编辑消息和登陆页面报表。</li></ul>|
|管理|<ul><li>**[!DNL Manage subdomains delegation]**:读取、创建、编辑和删除子域委派。</li><li>**[!DNL Manage IP pools]**:读取、创建、编辑和删除ip池。</li><li>**[!DNL Manage PTR records]**:读取和编辑PTR记录。</li><li>**[!DNL View PTR records]**:对PTR记录的只读访问。</li><li> **[!DNL Manage messages general settings]**:读取、创建、编辑和删除消息常规设置。</li><li>**[!DNL Manage messages presets]**:读取、创建、编辑和删除内容品牌。</li><li>**[!DNL Manage suppression rules]**:访问读取、创建、编辑和删除隐藏规则。</li><li>**[!DNL View suppression list]**:读取和导出本地抑制列表。</li><li>**[!DNL Manage alerts]**:启用/禁用旅程、消息和授权的警报。</li><li>**[!DNL Manage landing page settings]**:读取、创建和编辑登陆页面子域和预设设置。</li></ul>|
|决策管理|<ul><li>**[!DNL Manage decisions]**:读取、创建、编辑和删除决策。</li><li>**[!DNL Manage ranking strategies]**:读取、创建、编辑和删除自定义消息报表以及使用操作功能。</li></ul>|
|Adobe Experience Platform|<ul><li>**[!DNL Sandbox]**:授予对沙箱的访问权限。</li><li>**[!DNL Manage segments]**:读取、创建、编辑和删除区段和订阅列表。</li><li>**[!DNL Manage profiles]**:读取、创建、编辑和删除用户档案。</li><li>**[!DNL Read datasets]**:对数据集的只读访问权限。</li><li>**[!DNL Read schemas]**:对架构的只读访问。</li><li>**[!DNL Read Identity namespace]**:对身份命名空间的只读访问权限。</li><li>**[!DNL Manage merge policies]**:读取、创建、编辑和删除合并策略。</li></ul>|
...
|消息| <ul><li>**[!DNL Manage messages]**:读取、创建、编辑和删除消息和登陆页面。</li><li>**[!DNL Publish messages]** 发布消息和登陆页面。</li><li>**[!DNL Manage messages preview and test]**:读取、创建和编辑消息/登陆页面预览并发送测试/校样。</li><li>**[!DNL View messages report]**:阅读和编辑消息和登陆页面报表。</li></ul>|
|决策管理| <ul><li>**[!DNL Manage decisions]**:读取、创建、编辑和删除决策实体。</li><li>**[!DNL Manage ranking strategies]**:读取、创建、编辑和删除自定义消息报表以及使用操作功能。</li></ul>| |Adobe Experience Platform| <ul><li>**[!DNL Manage segments]**:读取、创建、编辑和删除区段和订阅列表。</li><li>**[!DNL Manage profiles]**:读取、创建、编辑和删除用户档案。</li><li>**[!DNL Read datasets]**:对数据集的只读访问权限。</li><li>**[!DNL Read schemas]**:对架构的只读访问。</li><li>**[!DNL Manage merge policies]**:读取、创建、编辑和删除合并策略。</li></ul>|
...
|消息| <ul><li>**[!DNL Manage messages]**:读取、创建、编辑和删除消息和登陆页面。</li><li> **[!DNL Manage messages preview and test]**:读取、创建和编辑消息/登陆页面预览并发送测试/校样。</li><li>**[!DNL View messages report]**:阅读和编辑消息和登陆页面报表。</li></ul>|
|决策管理| <ul><li>**[!DNL Manage decisions]**:读取、创建、编辑和删除决策实体。</li><li>**[!DNL Manage ranking strategies]**:读取、创建、编辑和删除自定义消息报表以及使用操作功能。</li></ul>| |Adobe Experience Platform| <ul><li> **[!DNL Manage segments]**:读取、创建、编辑和删除区段和订阅列表。</li><li>**[!DNL Manage profiles]**:读取、创建、编辑和删除用户档案。</li><li>**[!DNL Read datasets]**:对数据集的只读访问权限。</li><li>**[!DNL Read schemas]**:对架构的只读访问。</li><li>**[!DNL Manage merge policies]**:读取、创建、编辑和删除合并策略。</li></ul>|
|管理| <ul><li>**[!DNL View messages presets]**:对消息预设的只读访问权限。</li></ul>|
...
|消息| <ul><li>**[!DNL View messages]**:对消息和登陆页面的只读访问权限。</li><li>**[!DNL View messages report]**:对消息和登陆页面报表的只读访问权限。</li></ul>|
