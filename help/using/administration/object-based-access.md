...
要[创建标签](#create-labels)，您必须是具有&#x200B;**[!UICONTROL 管理使用标签]**&#x200B;权限的角色的一部分。

要[分配标签](#assign-labels)，您必须是具有&#x200B;**管理**&#x200B;权限（即[!DNL Manage journeys]、[!DNL Manage Campaigns]或[!DNL Manage decisions]）的角色的一部分。 如果没有此权限，**[!UICONTROL 管理访问权限]**&#x200B;按钮将灰显。
