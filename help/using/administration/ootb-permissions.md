...
| 功能 | 权限 |
|-|-|
| AI 助手 | **[!DNL Generate content]**：访问Journey Optimizer中的AI助手。 |
...
| 沙盒管理 | **[!DNL Export sandboxes]**：能够导出沙盒。</br>**[!DNL Manage packages]**：读取、创建、编辑和删除包。</br>**[!DNL Manage sandboxes]**：读取、创建、编辑和删除沙箱。</br>**[!DNL View sandboxes]**：属于您组织的沙盒的只读访问权限。</br>**[!DNL Reset sandboxes]**：能够重置沙盒。 |
| 翻译服务 | **[!DNL Manage translation projects]**：读取、创建、编辑和删除翻译项目。</br>**[!DNL View translation projects]**：对翻译项目的只读访问权限。</br>**[!DNL Manage translation tasks]**：读取、创建、编辑和删除翻译任务。</br>**[!DNL View translation tasks]**：对翻译任务的只读访问权限。</br> **[!DNL Manage translation reviews]**：读取、创建、编辑和删除翻译审核。</br>**[!DNL View translation reviews]**：对翻译审阅的只读访问权限。</br>**[!DNL Manage translation in house]**：在内部读取、创建、编辑和删除翻译。</br>**[!DNL View translation in house]**：内部翻译的只读访问权限。</br>**[!DNL Manage translation settings]**：读取、创建、编辑和删除翻译设置。 |
