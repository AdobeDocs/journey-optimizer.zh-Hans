...
| 编排的营销活动 | **[!DNL Manage orchestrated campaigns]**：读取、创建、编辑和删除编排的营销活动。</br>**[!DNL Manage orchestrated campaigns admin]**：读取、创建、编辑和删除Adobe Experience Platform配置文件与关系存储实体之间的链接和协调。</br>**[!DNL Publish orchestrated campaigns]** (`orchestrated-campaign.publish`)：发布编排的营销活动。 使用信号触发编排的营销活动也需要此权限。 </br>**[!DNL View orchestrated campaigns admin]**：读取和编辑Adobe Experience Platform配置文件与关系存储实体之间的链接和协调。</br>**[!DNL View orchestrated campaigns]**：读取并编辑编排的营销活动。</br>**[!DNL View orchestrated campaigns report]**：读取并编辑编排的营销活动报告。 |
