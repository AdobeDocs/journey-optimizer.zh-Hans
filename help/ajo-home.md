...
在发行说明中了解 Journey Optimizer 的最新功能与改进。
...
>[!TAB CX Enterprise Coworker 中的 Journey Optimizer 技能]

我们新增了有关 **Coworker 中的 Journey Optimizer 技能**&#x200B;的文档页面，包括&#x200B;**以历程为中心**&#x200B;和&#x200B;**以忠诚度为中心**&#x200B;技能，并提供了指导和示例提示。
...
[探索历程](using/building-journeys/journey.md)
:::
...
[了解营销活动](using/campaigns/get-started-with-campaigns.md)
:::
...
[了解冲突管理](./using/conflict-prioritization/gs-conflict-prioritization.md)
:::
