...
Adobe Journey Optimizer 中的函数使您能够构建动态且精确的表达式，以定制客户历程。无论您是评估受众成员资格、聚合数据、转换格式、处理日期还是处理列表，每种类别的函数在优化工作流中都具有独特的作用。 借助数学计算、字符串自定义等工具，这些函数为构建高级条件提供了无限可能。在探索前面部分时，您可以找到简化复杂操作的实用示例和详细指南，以便轻松解锁个性化历程编排的完整潜力。
...
[深入了解聚合函数](../using/building-journeys/functions/aggregation-functions.md)
:::
...
[探索转换函数](../using/building-journeys/functions/conversion-functions.md)
:::
...
[查看日期函数文档](../using/building-journeys/functions/date-functions.md)
:::
...
- **[数学函数](../using/building-journeys/functions/math-functions.md)** - 探索 random 和 round 等数学函数，用于历程表达式中的数值计算。
- **[Adobe Journey Optimizer 中的字符串函数](../using/building-journeys/functions/string-functions.md)** - 在历程表达式中使用函数进行字符串操作，包括连接、子字符串提取、格式化等。
