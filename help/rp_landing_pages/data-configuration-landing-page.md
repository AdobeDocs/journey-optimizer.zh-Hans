...
title: 数据配置
description: 了解如何配置关系架构、数据集、定向维度和渠道设置，以便为 Journey Optimizer 中编排的营销活动提供支持。
...
了解如何设置和配置渠道配置，以便在编排的营销活动中使用，包括电子邮件和其他受支持的渠道。

[配置渠道](../using/orchestrated/channel-config.md)
:::
