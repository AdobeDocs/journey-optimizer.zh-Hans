...
description: 了解如何使用自定义操作，在 Journey Optimizer 历程中通过 Adobe Campaign Standard、Campaign v7/v8 和 Marketo Engage 发送消息。
...
[与 Campaign Standard 集成](../using/action/acs-action.md)
:::
...
[与 Campaign v7/v8 集成](../using/action/acc-action.md)
:::
