...
description: 了解如何使用自定义操作，通过Adobe Campaign Standard、Campaign v7/v8和Marketo Engage从Journey Optimizer历程发送消息。
...
[与Campaign Standard集成](../using/action/acs-action.md)
:::
...
[与Campaign v7/v8集成](../using/action/acc-action.md)
:::
