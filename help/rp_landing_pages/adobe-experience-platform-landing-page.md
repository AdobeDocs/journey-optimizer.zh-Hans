...
description: 了解如何在Journey Optimizer历程中使用Adobe Experience Platform数据和受众函数，包括inAudience函数。
...
将Adobe Experience Platform数据用于Personalization

了解如何访问和使用Adobe Experience Platform用户档案属性和数据集来个性化消息和历程条件。
...
在历程中使用Adobe Experience Platform数据

了解如何直接在旅程条件、操作和表达式中查询和查找Adobe Experience Platform数据。

[在历程中使用AEP数据](../using/data/lookup-aep-data.md)
:::
