...
title: API 参考
description: 了解如何使用优惠库API和投放API将决策管理集成到您的工作流中并大规模提供个性化优惠。
...
[探索投放API](offer-delivery-api-landing-page.md)
:::
...
访问用于管理投放位置、决策规则、收藏集限定符、个性化优惠、收藏集、后备优惠和决策的API参考。

[浏览选件库API](../using/offers/api-reference/getting-started.md)
:::
