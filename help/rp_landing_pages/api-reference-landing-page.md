...
title: API 参考
description: 了解如何使用产品建议库 API 和投放 API 将决策管理集成到您的工作流中并大规模提供个性化产品建议。
...
[浏览投放 API](offer-delivery-api-landing-page.md)
:::
...
访问用于管理投放位置、决策规则、收藏集限定符、个性化产品建议、收藏集、后备产品建议和决策的 API 参考内容。

[浏览产品建议库 API](../using/offers/api-reference/getting-started.md)
:::
