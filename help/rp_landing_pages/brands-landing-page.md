...
title: 品牌
description: 了解如何在Journey Optimizer中创建、管理和个性化品牌指南，以确保在所有营销活动中提供一致的品牌内内容。
...
了解如何设置默认品牌偏好和定制品牌指南，以便与AI生成的内容无缝集成。
...
了解如何创建和管理根据您的品牌准则培训的自定义创作AI模型，以实现一致的内容生成。

[管理创成模型](../using/content-management/generative-models.md)
:::
