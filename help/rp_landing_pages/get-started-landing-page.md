...
此部分介绍该平台的核心功能 – 从全渠道编排和 AI 驱动型决策到无缝内容和数据管理。您将了解这些功能强大的工具如何协同工作以优化每次客户互动。每个主题都以其前面一个主题为基础，指导您以动态、数据驱动的方式逐步掌握客户参与度。
...
[决策护栏和限制](../using/start/guardrails.md)
:::
...
- **[Adobe Journey Optimizer：关键术语](../using/start/terminology-md-redpen.md)** – 了解基本术语和概念，从而充满信心地使用 Adobe Journey Optimizer 并有效实施营销策略。
- **[无障碍功能](../using/start/accessibility.md)** – 了解无障碍功能并遵循 WCAG 标准，确保所有用户都能获得包容性的使用体验。
- **[AI 助手快速入门](../using/start/ai-assistant.md)** – 利用 AI 助手了解 Adobe Journey Optimizer 中的概念并获取运营洞察。
- **[故障排除](../using/start/troubleshooting.md)** – 每个故障排除部分均提供常见问题解答与问题解决方案。
- **[监视和故障排除](/help/rp_landing_pages/troubleshoot-journey-landing-page.md)** – 探索综合全面的工具，可用于追踪历程效果，识别潜在问题，并在问题出现时迅速加以解决。
