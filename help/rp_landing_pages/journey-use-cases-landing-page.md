...
- **[从实时历程中删除用户档案](https://experienceleague.adobe.com/zh-hans/docs/journey-optimizer/using/orchestrate-journeys/create-journey/journey-pause#journey-exit-criteria)** — 出于业务或运营原因，您可能需要从实时历程中删除一些用户档案，并排除与当前历程中特定条件匹配的用户档案。 可以通过暂停历程来执行此操作。
