...
+ 忠诚度挑战 {#loyalty-challenges}
   + [忠诚度挑战入门](using/loyalty-challenges/gs-loyalty-challenges.md)
   + [了解忠诚度挑战](using/loyalty-challenges/get-started.md)
...
+ 通信渠道 {#channels}
   ...
   + 推送通知渠道 {#push}
      ...
      + 配置推送通知 {#push-config}
         ...
         + [配置Web推送通知渠道](using/push/push-configuration-web.md)
...
+ 决策功能 {#decisioning}
   ...
   + 决策 {#experience-decisioning}
      ...
      + [从决策管理迁移到决策](using/experience-decisioning/migrate-to-decisioning.md)
