...
+ 新增功能 {#whats-new}
   ...
   + {hide-from-toc}[发行说明](using/rn/release-notes-2.md)
   + {hide-from-toc}[发行说明](using/rn/release-notes-3.md)
...
+ 忠诚度挑战 {#loyalty-challenges}
   ...
   + {hide-from-toc}[配置忠诚度计划](using/loyalty-challenges/loyalty-admin.md)
...
+ 通信渠道 {#channels}
   ...
   + 电子邮件渠道 {#email}
      ...
      + 设计电子邮件内容 {#design-email}
         ...
         + 创作您的内容 {#add-content}
            ...
            + [个性化URL](using/email/url-personalization.md)
   ...
   + 短信/彩信/RCS 渠道 {#mobile}
      ...
      + [设置SMS子域](using/mobile/mobile-subdomains.md)
...
+ 内容管理 {#content-management}
   ...
   + 跨解决方案用例 {#combine}
      ...
      + [使用Experience Manager Content Advisor](using/integrations/aem-content-advisor.md)
