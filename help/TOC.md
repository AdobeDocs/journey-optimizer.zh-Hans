...
user-guide-description: 使用Journey Optimizer为客户提供互联、情境式和个性化的体验
type: Documentation
...
+ [产品文档](ajo-home.md)
+ 入门指南{#get-started}
   + [什么是Journey Optimizer](using/get-started.md)
...
+ 消息{#create-messages}
   ...
   + 创建消息 {#create-message}
      ...
      + [配置电子邮件](using/configure-email.md)
      + [配置推送通知](using/configure-push.md)
   + [添加和管理资产](using/assets-essentials.md)
   + Email Designer {#email-designer}
      + [电子邮件设计入门](using/design-emails.md)
      + [在UI中设计电子邮件内容](using/create-email-content.md)
      + [导入或编码电子邮件内容](using/existing-content.md)
      + [使用电子邮件设计人员内容组件](using/content-components.md)
   + 个性化{#personalization}
      + [入门指南](using/personalization/personalize.md)
      ...
      + [个性化用例](using/personalization/personalization-use-case.md)
      + 模板语言{#functions}
         + [运算符](using/personalization/functions/operators.md)
         + [聚合](using/personalization/functions/aggregation.md)
         + [阵列和列表](using/personalization/functions/arrays-list.md)
         + [数学](using/personalization/functions/maths.md)
         + [地图](using/personalization/functions/maps.md)
         + [对象](using/personalization/functions/objects.md)
         + [字符串](using/personalization/functions/string.md)
   + [添加个性化优惠](using/deliver-personalized-offers.md)
   + 验证并发布{#create-message}
      + [预览和验证](using/preview.md)
      + [检查警报](using/alerts.md)
      + [发布消息](using/publish-manage-message.md)
   + [管理退出](using/consent.md)
+ 区段{#segment}
   + [关于区段](using/segment/about-segments.md)
   + [生成区段](using/segment/creating-a-segment.md)
+ 历程 {#orchestrate-journeys}
   + 关于journeys{#about-journeys}
   ...
   + 创建旅程{#create-journey}
      + [旅程入门](using/building-journeys/journey-gs.md)
      + [设计您的历程](using/building-journeys/using-the-journey-designer.md)
      + [测试您的旅程](using/building-journeys/testing-the-journey.md)
      + [发布您的旅程](using/building-journeys/publishing-the-journey.md)
      + [时区管理](using/building-journeys/timezone-management.md)
      + [解决您的旅程](using/building-journeys/troubleshooting.md)
   + 活动 {#about-journey-building}
      + [关于旅程活动](using/building-journeys/about-journey-activities.md)
      + [一般事件](using/building-journeys/general-events.md)
      + [反应](using/building-journeys/reaction-events.md)
      + [细分资格](using/building-journeys/segment-qualification-events.md)
      + [条件](using/building-journeys/condition-activity.md)
      + [结束](using/building-journeys/end-activity.md)
...
+ 跟踪和监视 {#reporting}
   ...
   + [消息监视](using/message-monitoring.md)
   + 实时报告{#live-report}
      + [概述](using/reports/live-report.md)
      + [历程实时报告](using/reports/journey-live-report.md)
      + [通过电子邮件发送实时报告](using/reports/email-live-report.md)
   ...
   + 历程报告{#reports}
      + [创建旅程报告](using/reports/sharing-overview.md)
   ...
   + 可投放性 {#deliverability}
      + [开始使用交付能力](using/deliverability.md)
      + [抑制列表](using/suppression-lists.md)
+ 决策管理{#offer-decisioniong}
   + 开始使用决策管理{#get-started}
   ...
   + 创建决策管理报表{create-reports}
      + [决策管理事件](using/offers/reports/get-started-events.md)
   ...
   + 导出优惠目录{#export-catalog}
      ...
      + [版面数据集](using/offers/export-catalog/export-placements.md)
      + [回退数据集](using/offers/export-catalog/export-fallback.md)
   + API 参考 {#api-reference}
      + [快速入门](using/offers/api-reference/getting-started.md)
      + 使用 API 创建和管理优惠 {#offers-api}
         + 投放位置{#placements}
            + [列表投放](using/offers/api-reference/offers-api/placements/placements-list.md)
            + [查找投放](using/offers/api-reference/offers-api/placements/lookup.md)
            + [创建投放位置](using/offers/api-reference/offers-api/placements/create.md)
            + [更新投放](using/offers/api-reference/offers-api/placements/update.md)
            + [删除投放](using/offers/api-reference/offers-api/placements/delete.md)
         + 决策规则 {#decision-rules}
         ...
         + 收藏集 {#collections}
            + [列出集合](using/offers/api-reference/offers-api/collections/collections-list.md)
            + [查找集合](using/offers/api-reference/offers-api/collections/lookup.md)
            + [创建集合](using/offers/api-reference/offers-api/collections/create.md)
            + [更新集合](using/offers/api-reference/offers-api/collections/update.md)
            + [删除集合](using/offers/api-reference/offers-api/collections/delete.md)
      ...
      + 使用API {#activities-api}创建和管理决策
         + [列表决策](using/offers/api-reference/activities-api/activities/activities-list.md)
         ...
         + [更新决定](using/offers/api-reference/activities-api/activities/update.md)
         + [删除决定](using/offers/api-reference/activities-api/activities/delete.md)
      + 优惠投放（使用API {#offer-delivery}）
         + [决策API](using/offers/api-reference/decisions-api/deliver-offers.md)
         + [Adobe Experience Platform Web SDK](using/offers/api-reference/web-sdk.md)
+ 配置 {#configuration}
   + [技术设置](using/administration.md)
   + [推送通知配置](using/push-configuration.md)
   + 事件配置 {#events-journeys}
      + [关于事件](using/event/about-events.md)
      + 配置统一事件{#unitary-events}
         + [使用统一事件](using/event/about-creating.md)
