...
user-guide-description: 使用Journey Optimizer为客户提供连接、情境式和个性化的体验
type: Documentation
...
+ 消息{#create-messages}
   ...
   + Email Designer {#email-designer}
      ...
      + [使用电子邮件设计工具内容组件](using/content-components.md)
   + 个性化{#personalization}
      + [快速入门](using/personalization/personalize.md)
      + [个性化区域](using/personalization/personalization-aeras.md)
      ...
      + 帮助程序函数{#functions}
         + [帮助程序函数列表](using/personalization/functions/functions.md)
...
+ 跟踪和监测 {#reporting}
   ...
   + 可投放性 {#deliverability}
      + [投放能力入门](using/deliverability.md)
   ...
   + 配置消息{#configuration}
      ...
      + 电子邮件配置{#email-config}
         + 委派子域{#delegate-subdomains}
            ...
            + [访问PTR记录](using/configuration/ptr-records.md)
         + [创建IP池](using/configuration/ip-pools.md)
         + 监视电子邮件地址{#monitor-reputation}
