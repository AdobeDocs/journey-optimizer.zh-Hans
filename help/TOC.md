...
user-guide-description: 使用Journey Optimizer ，为您的客户构建并提供连接、情境式和个性化的体验
type: Documentation
...
+ 历程 {#orchestrate-journeys}
   ...
   + 管理您的历程{#mannage-journey}
      ...
      + [历程疑难解答](using/building-journeys/troubleshooting.md)
   ...
   + 活动 {#about-journey-building}
      ...
      + [区段鉴别](using/building-journeys/segment-qualification-events.md)
      + [条件](using/building-journeys/condition-activity.md)
      + [等待](using/building-journeys/wait-activity.md)
      + [读取区段](using/building-journeys/read-segment.md)
   ...
   + 生成表达式 {#building-advanced-conditions-journeys}
      ...
      + 语法 {#syntax}
         ...
         + [运算符](using/building-journeys/expression/operators.md)
      ...
      + 函数 {#main-functions-journey}
         ...
         + 日期 {#date}
            + [当前时&#x200B;间InMillis](using/building-journeys/functions/functioncurrenttimeinmillis.md)
         ...
         + 列表 {#list}
            ...
            + [过滤器](using/building-journeys/functions/functionfilter.md)
         ...
         + 数学 {#math}
            + [随机](using/building-journeys/functions/functionrandom.md)
         ...
         + 字符串 {#string}
            ...
            + [替换](using/building-journeys/functions/functionreplace.md)
            + [replaceAll](using/building-journeys/functions/functionreplaceall.md)
            + [拆分](using/building-journeys/functions/functionsplit.md)
   ...
   + 用例 {#journey-use-cases}
      + 业务用例 {#business-use-cases}
         ...
         + [使用Campaign v7/v8发送消息](using/building-journeys/ajo-ac.md)
...
+ 促销活动{#campaigns}
   ...
   + [管理营销活动](using/campaigns/modify-stop-campaign.md)
...
+ 电子邮件渠道 {#email}
   ...
   + 设计电子邮件内容 {#design-email}
      ...
      + 开始创建内容 {#start-creating-content}
         + [从头开始](using/email/content-from-scratch.md)
...
+ Web渠道{#web}
   ...
   + [Visual Editing Helper扩展](using/web/visual-editing-helper.md)
   ...
   + 个性化 {#personalization}
      ...
      + 生成表达式 {#build-expressions}
         ...
         + 帮助程序函数{#functions}
            ...
            + [帮助者](using/personalization/functions/helpers.md)
            + [映射函数](using/personalization/functions/maps.md)
            + [对象函数](using/personalization/functions/objects.md)
...
+ 区段、用户档案和身份{#segment}
   ...
   + 用户档案{#profiles}
      + [用户档案入门](using/segment/get-started-profiles.md)
...
+ 跟踪和监视 {#reporting}
   ...
   + 历程报告 {#reports}
      ...
      + 旧版步骤事件字段 {#legacy-step-event-fields}
         ...
         + [数据获取字段](using/reports/sharing-fetch-fields.md)
         + [标识字段](using/reports/sharing-identity-fields.md)
      + [查询示例](using/reports/query-examples.md)
   + 投放能力 {#deliverability}
      + [投放能力入门](using/reports/deliverability.md)
...
+ 决策管理 {#offer-decisioning}
   ...
   + 创建组件 {#create-components}
      + [创建版面](using/offers/offer-library/creating-placements.md)
   ...
   + 创建排名 {#rankings}
      ...
      + AI模型 {#ai-models}
         + [关于AI模型](using/offers/ranking/ai-models.md)
   ...
   + 创建和管理决策 {#create-manage-activities}
      ...
      + [在决策中配置选件选择](using/offers/offer-activities/configure-offer-selection.md)
   ...
   + 创建决策管理报告 {#create-reports}
      ...
      + [访问事件XDM字段](using/offers/reports/xdm-fields.md)
   + 导出优惠目录 {#export-catalog}
      + [优惠目录导出入门 ](using/offers/export-catalog/get-started-export.md)
      + [访问导出的选件目录](using/offers/export-catalog/access-dataset.md)
   ...
   + API参考 {#api-reference}
      + [入门指南](using/offers/api-reference/getting-started.md)
      + 使用API创建和管理优惠 {#offers-api}
         + 版面 {#placements}
            + [列表版面](using/offers/api-reference/offers-api/placements/placements-list.md)
            + [查找投放](using/offers/api-reference/offers-api/placements/lookup.md)
            + [创建版面](using/offers/api-reference/offers-api/placements/create.md)
            + [更新投放](using/offers/api-reference/offers-api/placements/update.md)
            + [删除版面](using/offers/api-reference/offers-api/placements/delete.md)
         + 决策规则 {#decision-rules}
      ...
      + 使用API提供优惠 {#offer-delivery-api}
         ...
         + [批量决策API](using/offers/api-reference/offer-delivery-api/batch-decisioning-api.md)
...
+ 配置{#configuration}
   ...
   + [设置通道曲面](using/configuration/channel-surfaces.md)
   + 监控电子邮件地址 {#monitor-reputation}
      + [禁止列表](using/configuration/manage-suppression-list.md)
      + [重试](using/configuration/retries.md)
      + [允许的列表](using/configuration/allow-list.md)
   ...
   + 配置历程 {#configure-journeys}
      ...
      + 事件配置 {#events-journeys}
         ...
         + 配置统一事件 {#unitary-events}
            + [单一事件入门](using/event/about-creating.md)
            + [关于ExperienceEvent架构](using/event/experience-event-schema.md)
...
+ 隐私 {#privacy}
   ...
   + 管理同意 {#consent}
      + [管理选择退出](using/privacy/opt-out.md)
