...
此项目符合Adobe的要求 [行为准则](code-of-conduct.md). 参与本项活动时，您应遵守本准则。 请将不可接受的行为报告给
...
所有参与到该项目的第三方稿件都必须附有签署的参与者许可协议。 这将允许Adobe在项目中再次分发您贡献的内容。 [签署我们的CLA](http://opensource.adobe.com/cla.html). 您只需提交一次Adobe CLA即可，因此，如果您之前已提交过，则无需重新提交！
